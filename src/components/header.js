...
const Header = () => {
  ...
  return (
    <div className='sticky z-10 header top-0 text-3xl flex justify-between items-center text-red-500 font-bold p-3 border-b-2 border-gray-500'>
      <Link to={'/'}><span>Anime<span className='text-white'>Verse</span></span></Link>
      {useAppstate.login ?
      ...
      :
      <Link to={'/login'}><h1 className='text-xl rounded-md bg-green-500 cursor-pointer flex items-center'>
